...
/**
 * This class represents access for forwarding to the Error page 500.
 * 
 */

public class GoToError500 implements Command{
	
	private static final Logger log = Logger.getLogger(GoToError500.class);
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher(ConstantPage.ERROR500);
