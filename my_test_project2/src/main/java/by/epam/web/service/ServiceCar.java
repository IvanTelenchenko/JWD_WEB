...
/**
 * This interface represents access to the database car
 * */
...
public interface ServiceCar {
	...
	/**
	 * This method allows you to get map of a car filters
	 * @param listFilters The map consist of a {@link String} key that representing name filter and a <{@link String}> 
	 * value representing the array of values of that filter.
	 * @param date consist of a list of strings where first element is start date and second element is end date.
	 * @return return a map of car filters
	 */
	Map<String, List<String>> getMapOfCarFilters(Map<String, String[]> listFilters);
	
	/**
	 * This method allows you to get cars
